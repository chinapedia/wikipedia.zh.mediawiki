...
'''線形文字B音節文字'''是一个位于第一輔助平面的[[Unicode区段|Unicode区段]]，收录了[[線形文字B|線形文字B]]的[[音节文字|音节文字]]部分。
...
|-
| rowspan="8" | 4.0 || rowspan="8" width="180" | U+10000..1000B, 01000D..10026, 010028..1003A, 01003C..1003D, 01003F..1004D, 010050..1005D || rowspan="8" | 88 || {{nobr|[http://www.unicode.org/L2/L1997/97107-LinearB.pdf L2/97-107]}} || || {{Citation|title=Proposal to add the Linear B script to ISO/IEC 10646|date=1997-05-27|first=John H.|last=Jenkins}}
|-
