...
|名稱      = 我是演員 
|原名      = {{lang|ko|내가 배우다 }}
|圖片      = [[File:I_Am_The_Actor_Logo.jpg|260px]]
|圖說      = 
|類型      = [[真人實境秀|真人實境-{zh-tw:秀;zh-cn:秀;zh-hk:騷}-]]、[[綜藝節目|綜藝節目]]
|主持      = {{link-ko|卓在勛|탁재훈}}、{{link-ko|趙宇鍾|조우종}}
|國家      = {{ROK}}
|語言      = [[韓語|韓語]]
|標語      = 
|監製      = {{ubl|}}
|每集長度  = 
|製作公司  = [[SidusHQ|SidusHQ]]
|電視網    = {{link-ko|K STAR|K-STAR_(텔레비전_채널)}}
|視頻制式  = [[1080i|1080i]] [[高清電視|高清電視]]
|音頻制式  = [[立體聲|立體聲]]
|首播國家  = {{ROK}}
|集數      = 1－12
|開始      = {{start date|2017|4|11}}
|結束      = {{end date|2017|6|27}}
|官方網站  = http://kstar.ihq.co.kr/search/result_list.php?total_search_type=A&total_search_word=%B3%BB%B0%A1+%B9%E8%BF%EC%B4%D9
|imdb_id   = 
|related   =
}}
《'''我是演員'''》（{{kor|k='''내가 배우다 '''}}，{{lang-en|'''"I Am The Actor'''}}）是[[韓國|韓國]]綜合娛樂公司[[SidusHQ|SidusHQ]]製作的綜藝節目，由 {{link-ko|卓在勛|탁재훈}}、{{link-ko|趙宇鍾|조우종}}主持，而由[[澯美|澯美]]（[[AOA_(韓國)|AOA]]）、{{link-ko|金祚|금조_(가수)}}（[[Nine_Muses|Nine Muses]]）、[[李娜恩|李娜恩]]（[[APRIL|APRIL]]）、[[Nancy|Nancy]]（[[MOMOLAND|MOMOLAND]]）、{{link-ko|朴承俊|크나큰}}（[[KNK|KNK]]）、[[Jota|Jota]]（[[MADTOWN|MADTOWN]]）、[[鄭秀彬|鄭秀彬]]（[[VICTON|VICTON]]）、{{link-ko|有彬|송유빈}}（[[MYTEEN|MYTEEN]]）等人共同出演。節目主軸以找出歌手的演技能力，並由iHQ的演技老師指導，歌手彼此進行演技對決<ref>{{cite web|url=http://news1.kr/articles/?2929536|title='나는 배우다' 아이돌 8人, 드라마 주인공 걸고 연기 대결|date=2017-03-07|publisher=|accessdate=2017-05-14}}</ref>。最終優勝者有機會參與iHQ新劇演出。
...
!播放頻道!!播放日期!!播放時間!!備註
|-
|{{link-ko|K-STAR|K-STAR_(텔레비전_채널)}}
|2017年4月11日－2017年6月27日||每[[星期二|星期二]]18:00||獨立播放
|-
|}
