'''连续大Q埃尔米特多项式'''是以[[基本超几何函数|基本超几何函数]]定义的[[正交多项式|正交多项式]]<ref>Roelof Koekoek, Hypergeometric Orthogonal Polynomials and its q-Analogues, p509,Springer,2010</ref>


<math>H_{n}(x;a;q)=a^{-n}\;_{2}\phi_1\left(\begin{matrix} 
...
==极限关系==
令[[阿拉-萨拉姆-迟哈剌多项式|阿拉-萨拉姆-迟哈剌多项式]] b=0,即得[[连续大Q埃尔米特多项式}}


令[[连续大Q埃尔米特多项式|连续大Q埃尔米特多项式]] a=0,即得[[连续埃尔米特多项式|连续埃尔米特多项式]]

==图集==
{|
|[[File:CONTINUOUS_BIG_Q-HERMITE_POLYNOMIALS_ABS_COMPLEX_3D_MAPLE_PLOT.gif|thumb]]
|[[File:CONTINUOUS_BIG_Q-HERMITE_POLYNOMIALS_IM_COMPLEX_3D_MAPLE_PLOT.gif|thumb]]
|[[File:CONTINUOUS_BIG_Q-HERMITE_POLYNOMIALS_RE_COMPLEX_3D_MAPLE_PLOT.gif|thumb]]
|}
{|
|[[File:CONTINUOUS_BIG_Q-HERMITE_POLYNOMIALS_ABS_DENSITY_MAPLE_PLOT.gif|thumb]]
|[[File:CONTINUOUS_BIG_Q-HERMITE_POLYNOMIALS_IM_DENSITY_MAPLE_PLOT.gif|thumb]]
|[[File:CONTINUOUS_BIG_Q-HERMITE_POLYNOMIALS_RE_DENSITY_MAPLE_PLOT.gif|thumb]]
|}
