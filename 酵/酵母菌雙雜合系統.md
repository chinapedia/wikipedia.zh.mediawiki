[[File:Two_hybrid_assay.svg|thumb]]
'''酵母菌雙雜合系統'''，英文為Yeast two-hybrid system，亦簡稱Two-hybrid screening，是一種研究[[蛋白質交互作用|蛋白質交互作用]]
<ref name="young"> {{cite journal
 |author      = Young K
 ...
 |deadurl     = yes
 |archiveurl  = https://web.archive.org/web/20070927133205/http://www.biolreprod.org/cgi/reprint/58/2/302
 |archivedate = 2007-09-27
}} </ref>或蛋白質和DNA交互作用<ref name="joung">{{cite journal
...
|doi=10.1073/pnas.2135381100
}} </ref>的實驗技術。

此系統的基本原理是報導基因上游的啟動區域與[[轉錄因子|轉錄因子]]結合後，使下游的報導基因表現。在酵母菌雙雜合系統中將轉錄因子設計為結合區(Binding domain, BD)和活化區(Active domain, AD)，結合區可與基因上游的啟動區域結合，活化區負責活動下游報導基因開始[[轉錄|轉錄]]。<ref name="young"/><ref name="joung"/>

==歷史==
1989年Fields and Song率先開發出這項技術來研究蛋白質間的交互作用，他們最早使用的是''[[Saccharomyces_cerevisiae|Saccharomyces cerevisiae]]''這種酵母菌的GAL4表達系統，這種利用半乳糖影響基因表現原理<ref name="fields"> {{cite journal
...
|format=abstract
}} Abstract is free; full-text article is not. </ref>，來進行研究蛋白質和DNA交互作用、DNA間交互作用的篩選技術，在[[大腸桿菌|大腸桿菌]]中有更多的應用。<ref name="hurt"/>
==功用==
#探討蛋白質對應的[[生理|生理功能]]<ref>功能性探討蛋白質與蛋白質的交互作用 Functional Approaches to protein-protein interactions游佳融 1、李芳仁 1,21 台大醫院醫學研究部 2台大醫學院分子醫學研究所</ref>
#了解作用需啟用的蛋白質
#過濾沒有作用的蛋白質
#建立起蛋白質[[資料庫|資料庫]]
