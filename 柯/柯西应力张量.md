[[File:Components_stress_tensor_cartesian.svg|370px]]
...
</ref>，是[[连续介质力学|连续介质力学]]里用现时构形描述的二阶[[应力|应力]]张量，以法国数学家[[奥古斯丁·路易·柯西|奥古斯丁·路易·柯西]]的名字命名。该张量为对称张量，其九个分量（六个独立分量）表示某一点的应力状态。假设'''n'''为单位方向矢量，'''T'''<sup>('''n''')</sup>为通过与'''n'''垂直平面的应力矢量，则'''T'''<sup>('''n''')</sup>与'''n'''之间的关系为
