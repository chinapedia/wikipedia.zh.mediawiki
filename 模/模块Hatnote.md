...
local yesno -- lazily initialise [[Module:Yesno|Module:Yesno]]
...
function p.makeWikitextError(msg, helpLink, addTrackingCategory, title)
	...
	-- [[Module:Yesno|Module:Yesno]], and if we are not on a talk page, a tracking category
	-- is added.
