{{NoteTA|T=zh-hant:后對兵殘局;zh-hans:后对兵残局;|1=zh-hant:后;zh-hans:后;}}
{| align="right"
| [[File:Chess_kll44.png|File:Chess kll44.png]]
| [[File:Chess_qll44.png|File:Chess qll44.png]]
| [[File:Chess_kdl44.png|File:Chess kdl44.png]]
| [[File:Chess_pdl44.png|File:Chess pdl44.png]]
|}
在[[国际象棋|国际象棋]]中，一方剩下一个[[兵_(国际象棋)|兵]]，另一方剩下一个[[后_(国际象棋)|后]]，称为'''后对兵残局'''。这个残局通常是有后的一方取胜，但如果对方的兵已经前进到第六或第七行，就有可能以[[和局|和局]]结束。
...
以上的取胜方法对于车行兵是无效的。这是因为，当王被迫走到车行兵的前面时，它不能从另一侧出来，这样便造成了[[逼和|逼和]]。
...
|year=2003
|title=[[Basic_Chess_Endings|Basic Chess Endings]] (1941)
|publisher=McKay
|ID=ISBN 0-8129-3493-8
}}
* {{Citation
 |surname1=Flear|given1=Glenn|authorlink1=Glenn Flear
