...
在[[计算机科学|计算机科学]]中，'''二元决策图'''（{{lang-en|'''binary decision diagram, BDD'''}}），或译为'''二元判定图'''，是被用来表达一个[[布尔函数|布尔函数]]的一种[[数据结构|数据结构]]。
...
* [https://web.archive.org/web/20111101143950/http://myvideos.stanford.edu/player/slplayer.aspx?coll=ea60314a-53b3-4be2-8552-dcf190ca0c0b&co=18bcd3a8-965a-4a63-a516-a1ad74af1119&o=true Fun With Binary Decision Diagrams (BDDs)], lecture by [[Donald_Knuth|Donald Knuth]]
