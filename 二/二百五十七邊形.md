...
|caption=利用[[可縮放向量圖形|可缩放-{zh-hans:矢;zh-hant:向}-量图形]]繪製的正257邊形。看上去幾乎是一個[[圓形|圓形]]。
|edges=257
|S. symbol={257}
|C-D diagram={{CDD|node_1|2x|5|7|node}}
|angle=<math>\frac{45900}{257}</math> <sup><sup><sup><sup>'''Ｏ'''</sup></sup></sup></sup><br/>178.5992
}}
'''二百五十七邊形'''是[[多邊形|多邊形]]的一種。共有257條[[邊|邊]]，257個[[頂點|頂點]]，[[內角|內角]]和45900°，[[對角線|對角線]]32639條。

== 性質 ==
正二百五十七邊形的[[圓心角|圓心角]]和[[外角|外角]]約1.40[[角度|°]]，内角約178.60[[角度|°]]。
...
正二百五十七邊形即可以用[[尺規作圖|尺規作圖]]的方法繪出。[[卡爾·弗里德里希·高斯|高斯]]在1801年出版的《[[算術研究|算術研究]]》中的「二次同餘論」，證明了如果''p''為[[費馬素數|費馬素數]]，則正''p''邊形是可以[[尺规作图|尺规作图]]繪出。此外反過來亦證明如果[[質數|質數]]''p''對應的正''p''邊形可以繪圖的話，''p''就是費馬素數。在高斯得出此定理之前，已知的費馬素數只有[[3|3]]、[[5|5]]、[[17|17]]、[[257|257]]、[[65537|65537]]。
