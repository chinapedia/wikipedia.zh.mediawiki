...
{{unreferenced|time=2010-06-10T09:13:23+00:00}}
'''普遍文法'''（{{lang|en|Universal grammar}}，縮寫為 {{lang|en|UG}}），又譯為'''普遍語法'''，一種[[語言學|語言學]]理論，最有名的提倡者為[[诺姆·乔姆斯基|喬姆斯基]]。這個理論認為在人類能夠學習到各種[[文法|文法]]的普遍能力，是被內建在大腦中的。它被用來解釋[[語言習得|語言習得]]的一般過程，說明兒童在發展語言時，使用同一個法則，來學習不同的語言。

這個想法最早可以追溯到英國的哲學家[[罗吉尔·培根|培根]]。最早提出這個理論的語言學家，是[[诺姆·乔姆斯基|喬姆斯基]]、[[愛德華·薩丕爾|薩丕爾]]、與[[理查德·蒙塔古|理查德·蒙塔古]]。
...
[[诺姆·乔姆斯基|喬姆斯基]]認為，人類的大腦，只使用幾組固定而且有限的規則，來組織語言。因此，他假設所有的語言，在底層都擁有相同的文法結構。這幾組有限的規則，被稱為普遍文法（universal grammar）。
...
==參考文獻==
{{refbegin|2}}
*{{cite book |last=Ambridge |first=Ben |author2=Lieven |first2=Elena V. M. |title=Child Language Acquisition |publisher=Cambridge University Press |isbn=978-0-521-76804-7}}
...
*Pesetsky, David. [http://web.mit.edu/linguistics/people/faculty/pesetsky/Pesetsky_MITECS_Universals_UG.pdf "Linguistic Universals and Universal Grammar"]. In ''The MIT Encyclopedia of the Cognitive Sciences''. Ed. Robert A. Wilson and Frank C. Keil Cambridge, MA: MIT Press 1999.
...
*[[Michael_Tomasello|Tomasello, M.]] ''Constructing a Language: A Usage-Based Theory of Language Acquisition''. Harvard University Press, 2003. {{ISBN|0-674-01030-2}}.
...
* [http://ling.auf.net/lingBuzz/000100 {{книга|автор=Chomsky, Noam.|заглавие=Three factors in language design|год=2005}}]
* {{книга|автор=Jackendoff, Ray.|заглавие=Foundations of Language: Brain, Meaning, Grammar, Evolution|место=Oxford / New York|издательство=Oxford University Press|год=2002}}
...
* Tomasello, M. (1995): [https://web.archive.org/web/20150507054601/http://www.princeton.edu/~adele/MTLngNotInstinct.pdf ''Language is not an instinct.''] In: ''Cognitive Development'', 10, 131–156 (PDF-Datei; 1,9 MB)
...
==參見 ==
{{div col|cols=2}}
* [[Applicative_universal_grammar|Applicative universal grammar]]
* [[布若卡氏区|布若卡氏区]]
* [[生成文法|生成文法]]
* [[Linguistic_universal|Linguistic universal]]
* [[母語|母語]]
* [[優選理論|優選理論]]
* [[语言的起源|语言的起源]]
* [[Principles_and_parameters|Principles and parameters]]
* [[先天論|先天論]]
* [[Universal_Networking_Language|Universal Networking Language]]
{{colend}}
