...
| ImageFile = Trans-Isosafrol Structural Formula V1.svg
| ImageSize = 
| ImageCaption = ''反式-''異黃樟素
| ImageFile1 = Cis-Isosafrol Structural Formula V1.svg
| ImageSize1 = 185px 
| ImageCaption1 = ''順式-''異黃樟素
| ImageFile2 = Isosafrole-3D-balls.png
| ImageSize2 = 
| ImageName2 = Ball-and-stick model of isosafrole
| IUPACName = 5-(Prop-1-enyl)benzo[''d''][1,3]dioxole
...
| MeltingPtC = 8.2
| MeltingPt_notes =  ''trans''<br />-21.5 °C, ''cis''
| BoilingPtC = 253
| BoilingPt_notes =  ''trans''<br />77–79 °C, ''cis'' @ 3.5 mmHg}}
}}

'''異黃樟素'''是一種使用於香料工業，作香料用途的[[有機化合物|有機化合物]]。在分結構上，異黃樟素與[[苯丙烯|苯丙烯]]相似。它的香味令人聯想起[[八角|八角]]或[[甘草|甘草]]。異黃樟素在各種[[精油|精油]]少量存在，但最常用的是取得方法是在[[黃樟油|黃樟油]]取得[[黃樟素|黃樟素]]，然後對其進行[[異構化反應|異構化反應]]。異黃樟素有兩個[[順反異構體|順反異構體]]，''順式-''異黃樟素和''反式-''異黃樟素。
