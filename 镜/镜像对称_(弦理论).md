在[[代数几何|代数几何]]和[[理论物理|理论物理]]中，'''镜像对称'''是指[[卡拉比-丘流形|卡拉比-丘流形]]之间的一种特殊关系，即两种卡丘流形虽然在几何上差别很大，但是作为[[弦理论|弦理论]]的[[额外维度|额外维度]]时却是等价的。这样的一对流形被称为镜像流形。

镜像对称最早是由物理学家发现的。1990年左右，{{le|菲利普·坎德拉斯|Philip Candelas}}、齐妮娅·德·拉·奥萨（Xenia de la Ossa）、保罗·格林（Paul Green）和琳达·帕克斯（Linda Parks）发现它可以用于{{le|枚举几何|enumerative geometry}}，因此激发了数学家对此的兴趣。枚举几何是研究几何问题解的数量的数学分支。坎德拉斯和他的合作者证明了镜像对称可用于计算卡丘流形上[[有理曲线|有理曲线]]的数目，从而解决了一个长期的难题。尽管镜像对称最初的方法是从物理出发的，数学上并不严格，它的许多数学预测已经被[[数学证明|严格证明]]了。

目前，镜像对称是[[纯数学|纯数学]]中的热门话题，数学家正在物理直觉的基础上探索镜像对称的严格数学化表述。镜像对称也是进行[[弦论|弦论]]和[[量子场论|量子场论]]计算的重要工具，这两者都是物理学家用来描述[[基本粒子|基本粒子]]的理论。镜像对称的数学表述主要有[[马克西姆·孔采维奇|马克西姆·孔采维奇]]的{{le|同调镜像对称|Homological mirror symmetry}}，以及[[安德鲁·施特罗明格|安德鲁·施特罗明格]]、[[丘成桐|丘成桐]]和{{le|埃里克·扎斯洛|Eric Zaslow}}的{{le|SYZ猜想|SYZ conjecture}}。

==参见==
* {{le|唐纳森–托马斯理论|Donaldson–Thomas theory}}
* [[Wall-crossing|Wall-crossing]]
...
* {{cite journal |last=Kontsevich |first=Maxim |date=1995a |publisher=Birkhäuser |doi=10.1007/978-1-4612-4264-2_12|chapter=Enumeration of Rational Curves Via Torus Actions |title=The Moduli Space of Curves |isbn=978-1-4612-8714-8 |page=335 }}
