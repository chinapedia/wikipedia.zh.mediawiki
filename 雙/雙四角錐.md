...
| name = 雙四角錐
| polyhedron = 雙四角錐
| imagename = Square bipyramid.png
| rotating = Square bipyramid.png
| rinfo = 雙四角錐
| Type = [[雙錐體|雙錐體]]
| Coxeter_diagram = {{CDD|node f1|2|node f1|6|node}}<BR>{{CDD|node f1|2|node f1|3|node f1}}
| Face = 8
| Edge = 12
| Vertice = 6
| Face_type = [[三角形|三角形]]×8(側面) <br> 基底為[[四邊形|四邊形]]
| Vertice_type = 
| Schläfli = { } + {4}
| Face_configuration = V4.4.4
| Wythoff = 
| Symmetry_group = D<sub>4h</sub>, [4,2], (*224), order 16
| Index_references = 
| dual = [[四角柱|四角柱]]
| Rotation_group = D<sub>4</sub>, [4,2]<sup>+</sup>, (224), order 8
| Dihedral_angle = 
| Properties = [[凸集|凸]] 
| 3d_image = 
| vfigimage = 
| dual_image = Tetragonal prism.png
| net_image = 
}}
在[[幾何學|幾何學]]中，'''雙四角錐'''是指以[[四邊形|四邊形]]做為基底的雙錐體，由於雙錐體是由二個錐體疊起來的，因此不存在底面，因此只能討論其基底之形狀。當基底的形狀為正方形時會成為雙正四角錐又稱為正四角雙錐。若基底的形狀為正方形且每個面皆為正三角形則為正八面體。所有四角柱都有8個面6個頂點和12個邊。對偶多面體是[[四角柱|四角柱]]。
{| class=wikitable width=100
|- align=center
|[[File:Quadrilateral_bipyramid.png|100px]]<br/>只要基底是四邊形皆稱為雙四角錐
|}
== 正四角雙錐 ==
{{Main|正八面體}}
基底為正方形和且每一個面皆為正三角形的雙錐體稱為正四角雙錐，即是正八面體，是[[柏拉圖立體|柏拉圖立體]]之一。
{| class=wikitable width=150
|- align=center
|[[File:Octahedron.png|150px]]<br/>正四角雙錐
|}
== 長方雙錐 ==
基底為長方形的雙四角錐稱為長方雙錐。
{| class=wikitable width=200
|- align=center
|[[File:Rectangular_bipyramid.png|200px]]<br/>長方雙錐
|}
== 梯形雙錐 ==
基底是梯形的雙四角錐稱為梯形雙錐
{| class=wikitable width=150
|- align=center
|[[File:Trapezoid_bipyramid.png|100px]]<br/>梯形雙錐
|}
== 凹雙四角錐 ==
[[File:Concave_quadrilateral_bipyramid.png|thumb]]
