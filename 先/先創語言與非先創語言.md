'''先創語言'''({{lang|en|A priori (languages)}})與'''非先創語言'''({{lang|en|A posteriori (languages)}})是指稱[[人造語言|人造語言]]單詞來源的用語，可做為人造語言的一種分類法。先創語言和非先創語言的概念彼此對立。
...
像[[Ro語|Ro語]]、[[米拉德語|米拉德語]](Mirad)、[[索来索语|索来索语]]、[[克林貢語|克林貢語]]和[[納美語|納美語]]等，皆為先創語言的例子。

若以某些語言做為來源語言的話，則該來源語言的母語使用者在學習藉此所造出的語言時，可能會因此具有學習上的優勢。故有些人便以先創語言的原則設計其[[国际辅助语|国际辅助语]]，以消除此方面的不公平。
...
非先創語言可再分成三個子類：
*簡化語言，像[[基本英語|基本英語]](Basic English)和[[拉丁国际语|拉丁国际语]](Latino sine flexione)皆為其例。
*似自然語言(Naturalistic languages)，這類語言常常以某類自然語言為藍本創制(最常被用作藍本的是[[拉丁語|拉丁語]]和[[羅曼語族|羅曼語族]]語言)。像[[西方語|西方語]](Occidental language)和[[國際語|國際語]](Interlingua)皆為其例。
*自架構語言(Autonomous/schematic languages)，此類語言的語法是先創的，然其單字是非先創的。像[[世界語|世界語]]和[[沃拉普克语|沃拉普克语]]等皆為其例。

==參考文獻==
{{refbegin|2}}
*{{cite book |author=[[Umberto_Eco|Eco, Umberto]] |title=The search for the perfect language |publisher=Blackwell |location=Oxford |year=1995 |pages= |isbn=0-631-17465-6 |oclc= |doi= |accessdate=}}
