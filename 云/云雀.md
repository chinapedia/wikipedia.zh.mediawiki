{{noteTA
|T=zh-cn:云雀; zh-tw:歐亞雲雀; 
|1=zh-cn:云雀; zh-tw:歐亞雲雀; 
}}
{{Taxobox
| color = pink
| name = 云雀
...
| status_ref = <ref name="">{{IUCN2008|assessors=[[BirdLife_International|BirdLife International]]|year=2008|id=148915|title=Alauda arvensis|downloaded=2009-09-25}}</ref>
...
| species = '''云雀 ''A. arvensis'''''
| binomial = ''Alauda arvensis''
| binomial_authority = [[卡尔·林奈|Linnaeus]], 1758 
}}
[[File:_Alauda_arvensis_MHNT.jpg|thumb]]

'''云雀'''（[[学名|学名]]：''{{lang|la|Alauda arvensis}}''）又稱'''叫天子'''、'''告天子'''、'''告天鳥'''、'''阿蘭'''、'''大鷚'''、'''天鷚'''、'''朝天子'''等，隸屬於[[雀形目|雀形目]]，[[百靈科|百靈科]]。云雀體形似[[蒙古百靈|蒙古百靈]]，但個體較小，體長約19cm 左右，上體黑褐色，翅、尾各羽外緣淡棕色。最外側一對尾羽近純白色，緊挨著的一對外羽瓣為白色。下體白色，胸部淡棕色並有多數黑褐色斑點。其生活習性與蒙古百靈基本相似，云雀羽色雖不華麗，但鳴聲婉轉，歌聲嘹亮，能與蒙古百靈媲美，素有“南靈”之稱，是[[中國|中國]]著名的籠鳥，在國外也深受養鳥者歡迎。
