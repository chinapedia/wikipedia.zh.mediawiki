[[Image:Source_and_load_circuit_Z.png|frame]]
[[电路|电路]]的'''输入阻抗'''（{{lang-en|'''input impedance'''}}）是指电路从输入功率源方向“看进”电路时所等效的[[阻抗|阻抗]]。如果功率源提供了已知的电压和电流，这阻抗可以通过[[欧姆定律|欧姆定律]]求得。输入阻抗是电路的[[戴维寧定理|戴维寧等效]]，其模型是一个RL（电阻-电感）或RC（电阻-电容）组合，得到的等效电路能与原电路对外产生相同的响应效果。
...
*[http://www.sengpielaudio.com/calculator-voltagebridging.htm Interconnection of two audio units - Input impedance and output impedance]
