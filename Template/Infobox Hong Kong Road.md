<noinclude>{{Wraps infobox|Infobox street}}{{esoteric}}</noinclude>{{Infobox street
| embed = {{{embed|}}}
| name_sign_type = Hong Kong
| route = {{{route|{{{隸屬幹線|}}}}}}
| route2 = {{{route2|{{{隸屬幹線2|}}}}}}
...
| frame-latitude = {{{frame-latitude|{{{frame-lat|}}}}}}
| frame-longitude = {{{frame-longitude|{{{frame-long|}}}}}}
...
| length_ref3 = {{{length_ref3|}}}
| length = {{{length|{{{總長度|{{{路段總長度|{{{道路总长度|{{{总长度|}}}}}}}}}}}}}}}
