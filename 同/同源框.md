...
| Symbol = 同源框结构域（Homeodomain）
| Name = Homeodomain
| image = Homeodomain-dna-1ahd.png
| width = 
| caption = The ''[[Antennapedia|Antennapedia]]'' homeodomain protein from ''[[Drosophila_melanogaster|Drosophila melanogaster]]'' bound to a fragment of [[DNA|DNA]].<ref name="pmid7903398">{{PDB|1AHD}}; {{cite journal | vauthors = Billeter M, Qian YQ, Otting G, Müller M, Gehring W, Wüthrich K | title = Determination of the nuclear magnetic resonance solution structure of an Antennapedia homeodomain-DNA complex | journal = Journal of Molecular Biology | volume = 234 | issue = 4 | pages = 1084–93 | date = Dec 1993 | pmid = 7903398 | doi = 10.1006/jmbi.1993.1661 }}</ref> The recognition helix and unstructured N-terminus are bound in the major and minor grooves respectively.
| Pfam = PF00046
| Pfam_clan = CL0123
| InterPro = IPR001356
| SMART = SM00389
...
'''同源（异形）框'''（{{lang-en|Homeobox}}），或稱「'''同源匣'''」是某些影響[[動物|動物]]、[[真菌|真菌]]及[[植物|植物]]發育的[[基因|基因]]所擁有的一段[[DNA|DNA]]序列，擁有同源框的基因稱作'''同源异形基因'''，統稱同源异形基因家族。

這段序列之長度約180個[[核苷酸|核苷酸]]，能[[轉錄|轉錄]]出一段蛋白質[[结构域|结构域]]，稱為同源框结构域。
