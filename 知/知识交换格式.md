'''知识交换格式'''（{{lang|en|'''Knowledge Interchange Format'''}}，[[缩写|缩写]]为 '''{{lang|en|KIF}}'''）是一种面向计算机的语言，用于在不同的[[计算机程序|计算机程序]]之间交换[[知识|知识]]。
<!-- 
...
* {{en}}[http://www.ontologyportal.org 推荐上层合并本体（{{lang|en|Suggested Upper Merged Ontology}}）] 
* {{en}}[http://common-logic.org/ 普通逻辑（{{lang|en|Common Logic}}）]
