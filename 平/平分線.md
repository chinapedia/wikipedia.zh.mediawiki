{{Expand |time=2014-01-19T14:00:00+00:00 }}<!-- 本调用由 {{subst:Expand/auto}} 自动产生。 -->
[[File:Bisection_construction.gif|right]]
'''平分線'''是一條能將一條線段二等分的線。
...
[[File:Geo_AngleBesector.PNG|File:Geo AngleBesector.PNG]]
...
任意三角形ABC中，<math>{\angle}ABC</math>、<math>{\angle}BCA</math>、<math>{\angle}CAB</math> 角平分線交於一點I，則我們稱此點I為三角形ABC的[[內心|內心]]。
