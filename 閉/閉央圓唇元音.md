{{Expand English|Close central rounded vowel}}

{{Infobox IPA|ipa symbol1=ʉ|ipa symbol2=ü|ipa-number=318|ipa=649|ipa-image=Xsampa-rightcurly.png|xsampa=}|kirshenbaum=u"}}

'''閉央圓唇元音'''（[[Ʉ|Ʉ]]）是[[母音|母音]]的一種，使用於許多[[口語|口語]][[語言|語言]]之中，其[[國際音標|國際音標]]的符號為 {{IPA|{{尖括号|ʉ}}}}，另一种符号为 {{IPA|{{尖括号|ü/ue}}}}，相對應的[[X-SAMPA|X-SAMPA]]符號則為 {{尖括号|<tt>}</tt>}}。
...
==发音列表==
*[[英语|英语]]个别口音 - boot   /'''bʉ̟ːt/''' （[[船|船]]）
*[[爱尔兰语|爱尔兰语]] - ciúin 	/'''cʉ̠ːnʲ/''' （安静）
*[[挪威语|挪威语]] - hus '''	/hʉ͍ːs/''' （[[房子|房子]]）
*[[威尔士语|威尔士语]] - dŵr 	/'''dʉr/''' 	（[[水|水]]）
...
|last=Kristoffersen
|first=Gjert
|authorlink=:en:Gjert Kristoffersen
