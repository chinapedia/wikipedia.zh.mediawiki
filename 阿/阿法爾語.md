{{Infobox Language
|name=阿法爾語
|states={{flag|埃塞俄比亚}}<br />{{flag|厄立特里亚}}<br />{{flag|吉布提}}
|nativename={{lang|aa|Qafár af}}
|familycolor=Afro-Asiatic
|region={{flag|埃塞俄比亚}}<br />{{flag|厄立特里亚}}<br />{{flag|吉布提}}
|speakers=140萬至150萬
|fam2=[[庫希特語族|庫希特語族]]
|fam3=東庫希特語支
|fam4=[[低地東庫希特語支|低地東庫希特語支]]
|fam5=[[薩霍-阿法語|薩霍-阿法語]]
|iso1=aa|iso2=aar|iso3=aar}}

'''阿法爾語'''（'''Afar'''，{{lang|aa|''Qafár af''}}）屬於[[低地東庫希特語支|低地東庫希特語支]]，與薩霍語（Saho language）最接近，使用的地區包括[[埃塞俄比亞|埃塞俄比亞]]、[[厄立特里亞|厄立特里亞]]和[[吉布提|吉布提]]，使用者的[[識字率|識字率]]約百分之1至3，而使用阿法爾語的阿法爾人有150萬。與其他東庫希特語支一樣，阿法爾語採用[[主賓謂結構|主賓謂結構]]。<ref>Raymond G. Gordon, Jr, ed.  2005.  ''Ethnologue:  Languages of the World''.  15th edition.  Dallas:  Summer Institute of Linguistics.</ref>

== 發音 ==
=== 輔音 ===
阿法爾語中[[正字運動|正字]]的[[輔音|輔音]]讀音如下（括號內為[[國際音標|國際音標]]）︰
...
* 肯定動詞的尾音[[送氣|送氣]]（和[[重音|重音]]），如'''{{lang|aa|abeh}}''' 「他做」= {{IPA|/aˈbeʰ/}}。
* 否定動詞的尾音是不送氣（和不重音），如'''{{lang|aa|maabinna}}''' 「他沒有做」 = {{IPA|/ˈmaabinna/}}。
* 疑問動詞的尾音拉長（和重音），如'''{{lang|aa|abee?}}''' 「他做嗎」 = {{IPA|/aˈbeː/}}。
* 其他情況下，重音放在字末。
...
== 書寫方法 ==
阿法爾語以[[拉丁字母|拉丁字母]]或[[吉茲字母|吉茲字母]]書寫。

=== 拉丁字母 ===

<center>字母︰'''[[A|A]], [[B|B]], [[T|T]], [[S|S]], [[E|E]], [[C|C]], [[K|K]], [[X|X]], [[I|I]], [[D|D]], [[Q|Q]], [[R|R]], [[F|F]], [[G|G]], [[O|O]], [[L|L]], [[M|M]], [[N|N]], [[U|U]], [[W|W]], [[H|H]], [[Y|Y]]'''</center>

<center>字母名稱︰'''a, ba, ta, sa, e, ca, ka, xa, i, da, qa, ra, fa, ga, o, la, ma, na, u, wa, ha, ya'''</center>
...
* [http://rosettaproject.org/archive/aar/gen-1?page_view=image_view The beginning of Genesis 1 in Afar]{{dead link|date=十一月 2017 |bot=InternetArchiveBot }} at The Rosetta Project.

{{Afro-Asiatic languages}}

{{Authority control}}
[[Category:東庫希特語支|Category:東庫希特語支]]
[[Category:吉布地語言|Category:吉布地語言]]
