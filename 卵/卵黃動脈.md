{{Infobox embryology
| Name          = 卵黃動脈<br/>Vitelline arteries
| Latin         = Arteria vitellina
| GraySubject   =
| GrayPage      =
| Image         = Gray31.png
| Caption       = 人類胚胎的模型，長約1.3 mm（其中還看不到卵黃動脈，卵黃靜脈在左邊的中間）
| Image2        =
| Caption2      =
| System        =
| CarnegieStage = 13
...
'''卵黃動脈'''（'''vitelline arteries'''）是人體[[胚胎|胚胎]]的[[動脈|動脈]]之一，是對應{{le|卵黃靜脈|vitelline veins}}的動脈。卵黃動脈在{{le|卵黃循環|vitelline circulation}}中重要的部份，提供[[卵黃囊|卵黃囊]]的血液。卵黃動脈是{{le|背主動脈|dorsal aorta}}的分支之一。

卵黃動脈會發育為[[腹腔動脈|腹腔動脈]]、{{le|腸系膜上動脈|superior mesenteric artery}}及{{le|腸系膜下動脈|inferior mesenteric artery}}<ref>{{GPnotebook|120913981}}</ref>。
...
<!--* {{EmbryologyTemple|Heart98/heart97a/sld021}}-->
