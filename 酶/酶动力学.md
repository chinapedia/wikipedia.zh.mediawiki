{{expand|time=2017-11-25T13:25:58+00:00}}
{{expert|time=2017-11-25T13:25:58+00:00}}
[[Image:EcDHFR_raytraced.png|thumb]]的[[二氫葉酸還原酶|二氫葉酸還原酶]] 與它的兩個底物，二氫葉酸（右）與和NADPH（左），两个底物包裹于[[活性位点|活性位点]]之中。蛋白質用带状圖来表示，其中[[α螺旋|α螺旋]]用紅色表示，[[β折叠|β折叠]]用黃色表示，而转角用藍色表示。Generated from [http://www.rcsb.org/pdb/explore.do?structureId=7DFR 7DFR].]]
[[File:KinEnzymo(en).svg|thumb]]
'''酶动力学'''，又被称为'''酶催化动力学'''、'''酶反应动力学'''或'''酵素動力學'''，是研究酶[[催化|催化]]的[[化学反应|化学反应]]速率的学科。酶动力学对于某一特定酶的研究，可以提供许多重要信息。如该种酶的催化机理、在[[代谢|代谢]]途径中的作用、其在[[细胞|细胞]]中的活性如何被调控以及相关[[药物|药物]]和[[毒药|毒药]]如何抑制其活性。

当酶结合多个底物，如[[二氢叶酸还原酶|二氢叶酸还原酶]]（右图所示）时，酶动力学也可以显示这些底物结合的顺序和释放产物的顺序。

[[蛋白质结构|酶的结构]]的知识有助于解释动力学数据。 例如，结构可以表明底物和产物如何在催化过程中结合; 反应发生什么变化; 甚至特定[[氨基酸|氨基酸]]残基的作用机制。机制中有些酶显着改变形态; 在这种情况下，确定具有和不具有不经历酶反应的结合底物类似物的酶结构是有帮助的。

==历史==
1902年，维克多·亨利（Victor Henri）提出了对酶动力学进行定量的理论，<ref>{{cite journal|author=Henri,V.|year=1902|title= Theorie generale de l'action de quelques diastases|journal=Compt. rend. hebd. Acad. Sci. Paris|volume= 135|pages= 916-919}}</ref>但是由于忽略了溶液中氢离子浓度的影响，他的实验结果无法验证这一理论。在1909年，Peter Lauritz Sørensen提出了对数的pH尺度并引入“缓冲”这一概念后，<ref>{{cite journal|author=Sørensen,P.L.|year=1909|title= Enzymstudien {II}. Über die Messung und Bedeutung der Wasserstoffionenkonzentration bei enzymatischen Prozessen|journal=Biochem. Z.|volume= 21|pages= 131-304}}</ref>德国化学家Leonor Michaelis和他的加拿大博士后Maud Leonora Menten重复了Henri的实验，实验结果肯定了Henri所提出的方程。这一方程被称为Henri-Michaelis-Menten kinetics或Michaelis-Menten kinetics，中文对应名称为[[米氏方程|米氏方程]]。<ref>{{cite journal|author=Michaelis L., Menten M.|year=1913|title= Die Kinetik der Invertinwirkung|journal=Biochem. Z.|volume= 49|pages= 333–369}} [http://web.lemoyne.edu/~giunta/menten.html English translation] Accessed 6 April 2007</ref>这一工作被G. E. Briggs和J. B. S. Haldane所进一步发展，此二人所提出的动力学方程至今仍得到广泛使用。<ref>{{cite journal|url=http://www.biochemj.org/bj/019/0338/bj0190338_browse.htm|author=Briggs G. E., Haldane J. B. S.|year=1925|title= A note on the kinetics of enzyme action|journal=Biochem. J.|volume=19|pages=339–339|id= PMID 16743508}}</ref>
