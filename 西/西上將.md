...
{{Starbox observe
| epoch=J2000
| ra={{RA|11|21|08.1943}}<ref name=aaa323_L49/>
| dec={{DEC|+06|01|45.558}}<ref name=aaa323_L49/>
| appmag_v=4.046<ref name=Cousins1984/>
| constell=[[狮子座|狮子座]]
}}
{{Starbox character
| class=B9.5 Vs<ref name=Chini2012/>
| b-v=–0.06<ref name=clpl4/>
| u-b=–0.12<ref name=clpl4/>
| variable=
}}
{{Starbox astrometry
| radial_v=–5.3<ref name=gcsrv53/>
| prop_mo_ra=–91.76<ref name=aaa323_L49/>
| prop_mo_dec=–12.83<ref name=aaa323_L49/>
| parallax=15.24
| p_error=0.81
| parallax_footnote=<ref name=aaa323_L49/>
| absmag_v= −0.10<ref name=Anderson2012/>
}}
{{Starbox detail
| mass=2.76<ref name=David2015/>
| radius=3.3<ref name=mnras385_1_481/>
| luminosity=133<ref name=Anderson2012/>
| temperature=10,250<ref name=mnras385_1_481/>
| metal_fe=+0.0<ref name=mnras385_1_481/>
| rotation=
| rotational_velocity=70<ref name=csrv/>
| gravity={{Val|3.83|0.03}}<ref name=aj129_3_1642/>
| age_myr=293<ref name=David2015/>
}}
{{Starbox catalog
| names = {{odlist | B=σ Leo | F=77 Leo | BD=−06° 2437 | FK5=427 | HD=98664 | HIP=55434 | HR=4386 | SAO=118804 | GC=| LHS=}}<ref name=simbad>{{cite web | title=sig Leo -- Star | work=SIMBAD | publisher=Centre de Données astronomiques de Strasbourg | url=http://simbad.u-strasbg.fr/simbad/sim-basic?Ident=Sigma+Leonis | accessdate=2010-06-23 }}</ref>
}}
{{Starbox reference
|Simbad=sig+Leo
}}
...
'''西上將'''（'''σ Leo''' / '''狮子座σ'''）也称'''太微右垣二'''，是[[狮子座|狮子座]]的一颗蓝白恒星，在中国古代[[星官|星官]]中属于[[太微垣|太微垣]]的[[:Category:太微右垣|太微右垣]]。它[[视星等|视星等]]为+4.05，是狮子座的第四亮星，[[恒星分类|光谱型]]B9.5V。
...
<ref name=Chini2012>{{citation
 ...
 | doi=10.1111/j.1365-2966.2012.21317.x | bibcode=2012MNRAS.424.1925C | arxiv=1205.5238}}</ref>
...
<ref name=gcsrv53>{{cite book | last=Wilson | first=Ralph Elmer | date=1953 | title=General Catalogue of Stellar Radial Velocities | publisher=Carnegie Institution of Washington | location=Washington | bibcode=1953GCRV..C......0W }}</ref>
...
<ref name=mnras385_1_481>{{cite journal | author=Lipski, Ł.| author2=Stȩpień, K. | title=Effective temperatures of magnetic chemically peculiar stars from full spectral energy distributions | journal=[[Monthly_Notices_of_the_Royal_Astronomical_Society|Monthly Notices of the Royal Astronomical Society]] | volume=385 | issue=1 | pages=481–492 |date=March 2008 | doi=10.1111/j.1365-2966.2008.12856.x | bibcode=2008MNRAS.385..481L |arxiv = 0712.3664 }}</ref>
...
[[Category:佛氏天体|狮子座77]]
[[Category:HD和HDE天体|098664]]
[[Category:HIP天体|055434]]
[[Category:HR天体|4386]]