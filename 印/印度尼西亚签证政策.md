外国人在进入'''[[印尼|印尼]]'''之前，需要到印尼各大[[使领馆|使领馆]]办理签证后才能入境，除非该国公民具有免签入境的资格。

[[File:Visa_policy_of_Indonesia.png|800px]]的安排]]

==一般入境要求==
所有旅客的[[护照|护照]]有效期必须不少于6个月，同时还需要出示回程车/机票。<ref>[http://www.deplu.go.id/Pages/ServiceDisplay.aspx?IDP=7&IDP2=21&Name=ConsularService&l=en 印尼落地签证] {{webarchive|url=https://web.archive.org/web/20140402093454/http://www.deplu.go.id/Pages/ServiceDisplay.aspx?IDP=7&IDP2=21&Name=ConsularService&l=en |date=2014-04-02 }}，[[印度尼西亚外交部|印度尼西亚外交部]]</ref>所有旅客在办理入境手续时，都有可能会被要求出示必要的文件（例如酒店预定证明和资产证明），另外，外国人入境时还需要填写海关申报单。

==免签证==
以下168个国家（地区）的公民可以免签证从印尼政府指定的124个口岸入境，停留期为30天。使用免签证进入印尼的旅客不能变更簽证类型或延长停留期限。<ref>{{cite web|author1=Directorate General of Immirartion, Ministry of Law and Human Rights of Indonesia|title=Visa Exemption|url=http://www.imigrasi.go.id/index.php/en/layanan-publik/bebas-visa}}</ref>
...
*{{flagcountry|United Kingdom}}(只限英國公民)
...
==落地签证==
68個国家的公民可在印尼出入境口岸申请[[落地签证|落地签证]]<ref>{{cite web|title=Visa on Arrival to Indonesia|url=http://www.kemlu.go.id/Pages/ServiceDisplay.aspx?IDP=7&IDP2=21&Name=ConsularService&l=en|publisher=Ministry of Foreign Affairs Republic Of Indonesia|deadurl=yes|archiveurl=https://web.archive.org/web/20130925102921/http://www.kemlu.go.id/Pages/ServiceDisplay.aspx?IDP=7&IDP2=21&Name=ConsularService&l=en|archivedate=2013-09-25}}</ref>，费用35[[美元|美元]]，可停留30天，并可额外延长30天。
...
若该国公民没有免签证或落地签证资格，则需要到印尼各大[[使领馆|使领馆]]办理签证后才能入境。任何国家的公民可在印尼机场过境停留8小时。

==移民部门批准==
下列10个国家的公民在得到印尼移民部门的批准后方可向印尼驻外机构申请签证：<ref>{{cite web|author1=Embassy of the Republic of Indoniesia in London, United Kingdom|title=VARIOUS VISA ISSUED ON APPROVAL (CALLING VISA)|url=http://www.indonesianembassy.org.uk/consular/consular_visa_type_approval.html|publisher=印尼驻英国大使馆|deadurl=yes|archiveurl=https://web.archive.org/web/20151212171133/http://www.indonesianembassy.org.uk/consular/consular_visa_type_approval.html|archivedate=2015-12-12}}</ref>
{|style=" {{border-radius|1em}} {{box-shadow|0.1em|0.1em|0.5em|rgba(0,0,0,0.75)}}; background-color: white; border: 1px solid white; padding: 5px;"
|
...
[[Category:各国签证政策|I]]
[[Category:印度尼西亚外交|Category:印度尼西亚外交]]