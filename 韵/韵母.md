...
{{音韻學}}
'''韵母'''是一個音節中除[[声母|声母]]外的部分。它必须包含[[響音|響音]]，一般是[[元音|元音]]。由一个元音构成的[[韵母|韵母]]称为'''单元音韵母'''，由多个元音构成的称为'''複元音韵母'''。

==現代標準漢語==
[[現代標準漢語|現代標準漢語]]中有13個普通韻母，由五個基本母音（/a/、/ə/、/i/、/u/和/y/）及兩個[[鼻音_(辅音)|鼻音]][[韻尾|韻尾]]（/n/和/ŋ/）組合而成，另外還有[[空韻|空韻]]（/ɨ/和/ɯ/）和一个特殊音節韻母/aɚ̯/。
...
|-
|/ɨ/、/ɯ/||-i||ㄭ[[File:U+312D.svg|16px]]|| 師與私的韵母<small><sup>1</sup></small>||/i/||i||ㄧ||亿||/u/||u||ㄨ||五||/y/||ü||ㄩ||与
...
<small><sup>2</sup> Iai（ㄧㄞ）僅存在于臺灣的[[中華民國國語|國語]]中「崖」等七字，中國大陆普通話讀音已改為yá。</small><br>
其中，只有一个元音或元音带鼻[[辅音|辅音]]时，该元音是[[韵腹|韵腹]]，所带的鼻辅音是韵尾。两个元音构成的韵母，则是开口度较大的是韵腹，韵腹前的元音是[[韵头|韵头]]，韵腹后的是韵尾。两个元音带一个鼻辅音，则中间的元音是韵腹，第一个元音是韵头，韵腹后的元音或鼻辅音是韵尾。所有韵母可根据韵头分为四类，称为[[四呼|四呼]]。二十世紀以來之拼音方案多半已將可作為韵头的/i/、/u/和/y/稱為介音或介母，可進一步簡化韻母數量。
...
|}
* 注音符號的韻母依照順序為（ㄧ、ㄨ和ㄩ可作為介母與其他韻母拼音，空韻ㄭ[[File:U+312D.svg|15px]]則多半不寫出）：
{|class=wikitable style="width:800px; text-align:center; font-size:1.25em;"
|ㄭ([[File:U+312D.svg|15px]])||ㄚ||ㄛ||ㄜ||ㄝ||ㄞ||ㄟ||ㄠ||ㄡ||ㄢ||ㄣ||ㄤ||ㄥ||ㄦ||ㄧ||ㄨ||ㄩ
|}
此外，還有[[元音的儿化现象|兒化韻母]]；漢語拼音中在韻母原始寫法後加r，不同韻母的[[兒化音|兒化音]]可能簡併，如ar, anr和air發音相同，也就是說，“牌兒”的发音等于“盤兒”。

==粵語==
粵語有94個[[韻母|韻母]]（包括自成音節的[m̩ ŋ̍]）<ref name="two">{{Cite book |author = 白宛如 |title = 廣州方言詞典 |location = 南京 | publisher = 江蘇教育出版社 |date = 1998年12月 |pages = 引論 叁 |ISBN =7-5343-3434-9|accessdate =  |url =  |language= zh-hant |quote =  }}</ref>：
...
==閩南語==
[[闽南语|閩南語]]的韻母（以[[白話字|白話字]]拼寫）如下表所示：
{|
|-
|valign=top|
{|class=wikitable
...
{{wikibooks}}
*[http://pinyin.info/readings/zyg/rules.html Basic Rules of Hanyu Pinyin Orthography] by [[Zhou_Youguang|Zhou Youguang]] (Pinyin.info. Now superseded by GB/T 16159-2012 below.)
...
*[http://www.ichineselearning.com/learn/pinyin-chart.html Pinyin Chart with Audio]
*[http://pinyin.quickmandarin.com/learn_chinese_quiz/blue/ Pinyin Tone Recognition Test]
*[http://www.pinyin.info Pinyin.info]
