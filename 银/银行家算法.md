...
'''银行家算法'''（Banker's Algorithm）是一个避免[[死锁|死锁]]（Deadlock）的著名算法，是由[[艾兹格·迪杰斯特拉|艾兹格·迪杰斯特拉]]在1965年为T.H.E系统设计的一种避免死結產生的演算法。它以银行借贷系统的分配策略为基础，判断并保证系统的安全运行。
...
== 虛擬碼(pseudo-code)<ref>[http://www.cs.huji.ac.il/course/2006/os/notes/notes4.pdf Concurrency]</ref> ==
...
=== 书籍 ===
* 《操作系统概念（Operating System Concepts）》第六版[https://books.google.com.hk/books?hl=zh-TW&id=bohQAAAAMAAJ&dq=Operating+System+Concepts+sixth+edition&q=bank+algorithm&pgis=1&redir_esc=y]
