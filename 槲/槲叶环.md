...
<!-- 檔案不存在 [[Image:Wreath.gif|right]] ，可從英文維基百科取得 -->
</div>

'''槲叶环'''（{{lang-la|corona civica}}）是一种以[[橡树|橡树叶]]编织而成的花冠状头冠，这在[[古罗马|古罗马]]时代是一项第二高等[[军功奖章|奖励品]]。它被颁授于那些以实際行动拯救同袍于危难中的罗马公民。<ref name=Pliny16.5>{{cite book|author=Pliny|authorlink=Pliny the Elder|coauthors=H. Rackham, Translator|title=Natural History|language=Latin, English|series=The Loeb Classical Library|volume=4|chapter=Book 16, Section 5|date=1986}}</ref>
