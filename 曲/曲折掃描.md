...
</syntaxhighlight>引用來源<ref>{{Cite web|url=https://loaighoraba.wordpress.com/2011/07/10/zigzag-scanning-source-code/|title=Zigzag scanning source code|accessdate=2016-06-30|date=2011-07-10|work=Loai Ghoraba's blog}}</ref>