{{Medical}}
{{Infobox disease 
 | Name            = 狼瘡性腎炎<br>({{lang|en|Lupus nephritis}})
 | Image           = Diffuse proliferative lupus nephritis - high mag.jpg
 | Caption         = [[顯微照相|顯微照相]]顯示"增生性狼瘡性腎炎"增加"系膜基質"及"系膜細胞"。[[腎活檢|腎活檢]]。[[PAS染色法|PAS染色法]]。
 | DiseasesDB      = 
...
'''狼瘡腎炎'''({{lang|en|Lupus nephritis}})是[[紅斑性狼瘡|紅斑性狼瘡]](SLE)造成的腎臟炎症，屬於一種[[免疫系统|免疫系统]]的疾病。除了腎臟，SLE也會損害[[皮膚|皮膚]]、[[關節|關節]]、[[神經系統|神經系統]]和在體內的幾乎任何器官或系統。

==症狀和病徵==
{{seealso|腎功能|腎生理學}}

狼瘡的一般症狀包括[[顴骨疹|顴骨疹]](malar rash)、盤狀疹(discoid rash)、光敏感(photosensitivity)、口腔潰瘍(oral ulcer)、非糜爛性關節炎(nonerosive arthritis)、胸膜心包炎(pleuropericarditis)、腎疾病、神經系統的表現，以及血液疾病。
...
約半數的SLE病例在同一時間或其他的情況被證實為狼瘡性腎炎。腎特異性第標誌包括蛋白尿(100％)、腎病綜合徵(55％)、顆粒管(30％)、紅細胞管型(10％)、鏡檢血尿(80％)，肉眼血尿(2％)、腎功能降低(60％)、[[急进性肾小球肾炎|RPGN]](30％)、[[急性腎損傷|ARF]](Acute kidney injury)(2％)、高血壓(35％)、高鉀血症（15％)及和管狀異常(70％)。
<!--
[[File:SLE_Nephritis_Pathology_Diagram.svg|thumb]]
In [[histology|histology]], stage I (minimal mesangial) disease has a normal appearance under light microscopy, but mesangial deposits are visible under [[electron_microscopy|electron microscopy]]. At this stage urinalysis is typically normal. 
...
[[File:Diffuse_proliferative_lupus_nephritis.jpg|thumb]]
...
==診斷==
狼瘡腎炎的診斷依賴於[[血液检查|血液检查]]、[[尿液分析|尿液分析]]、[[X射线|X射线]]、腎臟的[[超聲波|超聲波]]掃描，及[[腎活檢|腎活檢]](kidney biopsy)。<!--On urinalysis, a nephritic picture is found and RBC casts, RBCs and proteinuria is found.  
...
*Class I is [[minimal_mesangial_glomerulonephritis|minimal mesangial glomerulonephritis]] which is histologically normal on light microscopy but with mesangial deposits on electron microscopy. It constitutes about 5% of cases of lupus nephritis.<ref name=agabegi2nd-table6-4>Table 6-4 in: {{cite book |author=Elizabeth D Agabegi; Agabegi, Steven S. |title=Step-Up to Medicine (Step-Up Series) |publisher=Lippincott Williams & Wilkins |location=Hagerstwon, MD |year=2008 |pages= |isbn=0-7817-7153-6 |oclc= |doi= |accessdate=}}</ref> Renal failure is very rare in this form.<ref name=agabegi2nd-table6-4/>
*Class II is based on a finding of [[mesangial_proliferative_lupus_nephritis|mesangial proliferative lupus nephritis]]. This form typically responds completely to treatment with [[corticosteroids|corticosteroids]]. It constitutes about 20% of cases.<ref name=agabegi2nd-table6-4/> Renal failure is rare in this form.<ref name=agabegi2nd-table6-4/>
*Class III is [[focal_proliferative_nephritis|focal proliferative nephritis]] and often successfully responds to treatment with high doses of corticosteroids. It constitutes about 25% of cases.<ref name=agabegi2nd-table6-4/> Renal failure is uncommon in this form.<ref name=agabegi2nd-table6-4/>
*Class IV is [[diffuse_proliferative_nephritis|diffuse proliferative nephritis]]. This form is mainly treated with corticosteroids and immunosuppressant drugs. It constitutes about 40% of cases.<ref name=agabegi2nd-table6-4/> Renal failure is common in this form.<ref name=agabegi2nd-table6-4/>
*Class V is [[membranous_nephritis|membranous nephritis]] and is characterized by extreme edema and protein loss. It constitutes about 10% of cases.<ref name=agabegi2nd-table6-4/> Renal failure is uncommon in this form.<ref name=agabegi2nd-table6-4/>
