'''战略计划'''（英語：'''Strategic planning'''）又作'''策略計畫'''，指一項受到重視，必須[[大規模|大規模]]運作的[[计划|计划]]，在達成目的的過程中要運用各種[[战略|战略]]，這類計畫運用在不同的領域，如在[[管理學|管理學]]中是[[工商模型|工商模型]]的一部分，另外也常用在[[軍事|軍事]]上。
...
* [http://www.strategyplus.org Association for Strategic Planning] is a non-profit 501(c)(6) professional organization whose mission is to enable people and organizations to succeed through improved strategic thinking, planning, and action.

=== 文献 ===
* [https://web.archive.org/web/20070410234103/http://arts.endow.gov/resources/Lessons/index.html Planning for Governmental Agencies] is a resource that provides an article for public-sector planning by the National Endowment for the Arts.
