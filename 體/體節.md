...
| System        =
| CarnegieStage = 9
| Days          = 20<ref name="umedumt">{{cite web |url=http://staff.um.edu.mt/acus1/Gasrtrulation.htm |title=The Third Week Of Life: |accessdate=2007-10-13 |work=}}</ref>
| Precursor     = {{le|軸旁中胚層|p̺araxial mesoderm}}
| GivesRiseTo   = {{le|Cutis plate|Cutis plate|皮層}}、{{le|肌層|myotome}}、[[生骨節|生骨節]]
| MeshName      = Somites
| MeshNumber    = A16.254.425.660.750
| Code          = [[Terminologia_Embryologica|TE]] E5.0.2.2.2.0.3
}}
'''體節'''（somite or metamere）為動物胚胎中身體分節發育的單位。

== 節肢動物==
在原始[[甲殼類|甲殼類]]中，體節被認為是身體構造的一部分。再現生甲殼類身上，某些體節可能已經融合。
