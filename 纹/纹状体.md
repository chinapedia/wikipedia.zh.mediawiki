[[Image:Basal-ganglia-coronal-sections-large.png|thumb]]、[[蒼白球|蒼白球]]（globus pallidus）：[[蒼白球外核|蒼白球外核]]（globus pallidus external segment，GPe）、  [[丘腦下核|丘腦下核]]（subthalamus nucleus，STN）、[[蒼白球內核|蒼白球內核]]（globus pallidus internal segment，GPi），與[[黑質體|黑質體]]（substantia nigra，SN）。]]

'''紋狀體'''是[[端腦|端腦]]皮質下的一部份。這是[[基底核|基底核]]的主要輸入區。在解剖學上，紋狀體包括了[[尾核|尾核]]（Caudate nucleus）和[[被殼|被殼]]（Putamen）。 具有调节肌肉张力、协调复杂运动的功能。

==歷史==
在17世紀與18世紀時，詞彙「Corpus striatum」（紋狀體）用于称呼腦半球深色的皮質下部分（Vieussens, 1685）。福格茨（Vogts）（Cécile and Oskar, 1941）簡化了命名法，提議將「striatum」詞彙用在所有紋狀的組成元素（參見[[主要基底核系統|主要基底核系統]]），包括[[尾核|尾核]]（Caudate nucleus）、[[被殼|被殼]]（Putamen）與[[基層紋體|基層紋體]]（fundus striati），後者是前述二部份連結至[[內囊|內囊]]（internal capsule）以下的腹側部分。

「neostriatum」（新紋狀體）是由[[比較解剖學|比較解剖學家]]所創造的辭彙，他們比較了脊椎動物間的下皮質結構，因為新紋狀體被認為是腦部紋狀體的系統發生的新生部分。
...
==參照==
*[[人腦區域列表|人腦區域列表]]（List of regions in the human brain）
