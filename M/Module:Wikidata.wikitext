...
-- got idea from [[:w:Module:Wd|:w:Module:Wd]]
	...
	if isType(claims, "wikibase-entityid") then
		...
		for k, v in pairs(claims) do
			...
			if sitelink then
				...
				out[#out + 1] = "[[:d:"_.._qnumber_.._"|" .. label .. "]]<abbr title='" .. i18n["errors"]["local-article-not-found"] .. "'>[*]</abbr>"
			end
		end
...
p.getQualifierValue = function(frame)
	local function outputValue(value)
		...
		if (mw.wikibase.sitelink(qnumber)) then
			return "[["_.._mw.wikibase.sitelink(qnumber)_.._"|" .. mw.wikibase.sitelink(qnumber) .. "]]"
		else
			return "[[:d:"_.._qnumber_.._"|" ..qnumber .. "]]<abbr title='" .. i18n["errors"]["local-article-not-found"] .. "'>[*]</abbr>"
		end
	end
