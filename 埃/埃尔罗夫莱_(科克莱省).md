...
|subdivision_name2      = [[阿瓜杜尔塞区|阿瓜杜尔塞区]]
|leader_title           = 
|leader_name            = 
...
|population_total       = 8369
|population_footnotes   = <ref name=inec/>
|population_density_km2 = 38.2
|population_note        = 人口密度数据由计算得出
|timezone1              = [[北美东部时区|东部时区]]
|utc_offset1            = −5
|latd=8 |latm=10 |lats=12 |latNS=N
|longd=80|longm= 39|longs=0 |longEW=W
}}

'''埃尔罗夫莱'''是[[巴拿马|巴拿马]][[科克莱省|科克莱省]][[阿瓜杜尔塞区|阿瓜杜尔塞区]]的一个城市。 该市面积为{{convert|218.8|sqkm|sqmi}}，2010年时人口为8,369，故其人口密度为{{convert|38.2|PD/sqkm|PD/sqmi}}<ref name=inec/>。
