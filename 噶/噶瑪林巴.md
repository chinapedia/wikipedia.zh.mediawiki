{{unreferenced|time=2011-07-16T18:41:03+00:00}}
{{Infobox religious biography
| name             = 噶瑪林巴<br>Karma Lingpa
| native_name      = {{bo|ཀརྨ་གླིང་པ་་|w=kar ma gling pa}}
| order            = [[Nyingma|Nyingma]]
| birth_date       = 1326
| death_date       = 1386
| reincarnation_of = Chokro Lü Gyeltsen
| profession       = [[Tertön|Tertön]], revealer of the ''[[Bardo_Thodol|Bardo Thodol]]''.
}}

'''噶瑪·林巴'''（Kar ma gling pa，{{lang-en|Karma Lingpa}}，{{bd|1350年||?|}}），[[寧瑪派|寧瑪派]]上師之一，著名的[[伏藏師|伏藏師]]，相傳他曾受到[[蓮花生|蓮花生]]大士的啟發，取出[[伏藏|伏藏]]《[[文武百尊自解脫智|文武百尊自解脫智]]》，詳述了[[中陰|中陰]]教義，傳授了一系列的[[文武百尊|文武百尊]]法教。
...
==延伸閱讀==
{{refbegin}}
* {{Citation | last =Reynolds | first =John Myrdin | year =1989 | title =Self-Liberation through seeing with naked awareness | publisher =Station Hill Press, Inc.}}
{{refend}}

{{DEFAULTSORT:Lingpa, Karma}}
