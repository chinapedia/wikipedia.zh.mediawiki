{{update|time=2013-04-05T14:09:31+00:00}}
...
'''上海申花足球俱乐部2011赛季'''是上海申花第8赛季中超联赛。本主题主要介绍上海申花球员统计、各项比赛记录及俱乐部在2011赛季的资料。
...
===纪律处罚统计===
<!-- Tip: for players' data, just copy from the Squad stats section -->
{{Fb disc header}}
...
|}
{{col-2}}
<table style="float: center; width: 200px; border: 0px">
<tr><td>
<div style="position: relative;">
[[Image:Soccer_Field_Transparant.svg|200px]]
{{Image label|x=0.235|y=0.00|scale=350|text=<font size=1 color="Blue">[[上海申花|上海申花]]</font>}}
{{Image label|x=0.27|y=0.79|scale=350|text={{flagicon|CHN}}</font>}}
{{Image label|x=0.26|y=0.84|scale=350|text=<font size=1 color="Blue">[[王大雷|王大雷]]</font>}}

{{Image label|x=0.07|y=0.60|scale=350|text={{flagicon|CHN}}</font>}}
{{Image label|x=0.07|y=0.64|scale=350|text=<font size=1 color="Blue">[[王林|王林]]</font>}}

{{Image label|x=0.19|y=0.68|scale=350|text={{flagicon|CHN}}</font>}}
{{Image label|x=0.19|y=0.72|scale=350|text=<font size=1 color="Blue">[[戴琳|戴琳]]</font>}}

{{Image label|x=0.35|y=0.68|scale=350|text={{flagicon|CHN}}</font>}}
{{Image label|x=0.33|y=0.72|scale=350|text=<font size=1 color="Blue">[[邱添一|邱添一]]</font>}}

{{Image label|x=0.47|y=0.60|scale=350|text={{flagicon|CHN}}</font>}}
{{Image label|x=0.47|y=0.64|scale=350|text=<font size=1 color="Blue">[[吴曦|吴曦]]</font>}}
		
{{Image label|x=0.35|y=0.50|scale=350|text={{flagicon|CHN}}</font>}}
{{Image label|x=0.35|y=0.54|scale=350|text=<font size=1 color="Blue">[[姜坤|姜坤]]</font>}}

{{Image label|x=0.19|y=0.50|scale=350|text={{flagicon|CHN}}</font>}}
{{Image label|x=0.19|y=0.54|scale=350|text=<font size=1 color="Blue">[[于涛|于涛]]</font>}}		
				
{{Image label|x=0.08|y=0.38|scale=350|text={{flagicon|CHN}}</font>}}				
{{Image label|x=0.06|y=0.42|scale=350|text=<font size=1 color="Blue">[[安古洛|安古洛]]</font>}}
			
{{Image label|x=0.46|y=0.38|scale=350|text={{flagicon|CHN}}</font>}}
{{Image label|x=0.44|y=0.42|scale=350|text=<font size=1 color="Blue">[[冯仁亮|冯仁亮]]</font>}}

{{Image label|x=0.19|y=0.24|scale=350|text={{flagicon|COL}}</font>}}
{{Image label|x=0.17|y=0.28|scale=350|text=<font size=1 color="Blue">[[里亚斯科斯|里亚斯科斯]]</font>}}

{{Image label|x=0.36|y=0.22|scale=350|text={{flagicon|ARG}}</font>}}	
{{Image label|x=0.34|y=0.26|scale=350|text=<font size=1 color="Blue">[[路易斯·萨梅隆|萨梅隆]]</font>}}
...
===教练组===
{{fb oi header}}
{{fb oi information |bg=  |id= 主教练          |i={{flagicon|CHN}} [[奚志康|奚志康]] }}
{{fb oi information |bg=  |id= 技术顾问       |i={{flagicon|CHN}} [[可可维奇|可可维奇]] }}
{{fb oi information |bg=  |id= 领队              |i={{flagicon|CHN}} [[郭光琪|郭光琪]] }}
{{fb oi information |bg=  |id= 副领队          |i={{flagicon|CHN}} [[严翔|严翔]] }}
{{fb oi information |bg=  |id= 助理教练       |i={{flagicon|CHN}} [[成亮|成亮]] }}
{{fb oi information |bg=  |id= 体能及技战术教练       |i={{flagicon|ARG}} {{tsl|es|Armendáriz Néstor José|阿门达里兹·何塞}} }}
{{fb oi information |bg=  |id= 守门员教练       |i={{flagicon|ARG}} {{tsl|es|Lima Néstor Eduardo|利马·埃杜拉多}} }}
{{fb oi information |bg=  |id= 队医       |i={{flagicon|CHN}} [[魏明|魏明]] }}
{{fb oi information |bg=  |id= 队医       |i={{flagicon|CHN}} [[易云福|易云福]] }}
{{fb oi information |bg=  |id= 队务       |i={{flagicon|CHN}} [[章智勇|章智勇]] }}
{{fb oi information |bg=  |id= 队务       |i={{flagicon|CHN}} [[崔先喆|崔先喆]] }}
{{Fb oi footer||s=[http://www.shenhuafc.com.cn/drillmasterTeam.htm 申花教练组]}}
...
|goals2     = [[青木刚|青木刚]] {{yel|56}}<br>[[本田拓也|本田拓也]] {{yel|85}}
|stadium    = [[虹口足球场|虹口足球场]] 
|location =[[上海|上海]]
|attendance = 20036
